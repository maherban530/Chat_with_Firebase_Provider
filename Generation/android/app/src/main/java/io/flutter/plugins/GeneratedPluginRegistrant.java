...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.fintasys.gugor_emoji.GugorEmojiPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin gugor_emoji, com.fintasys.gugor_emoji.GugorEmojiPlugin", e);
    }
    try {
